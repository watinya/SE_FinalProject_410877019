...
public class addStuCourseFrame extends JFrame implements ActionListener {
	...
	public addStuCourseFrame(Administrator user, String id) {
		super("新增學生選修課程");
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == Jbtn_confirm) {
			...
			if(selectedSemester.equals("") || selectedCourse.equals("")) {
				...
				if(user.addStudentCourse(selectedSemester, selectedCourse, id)) {
					this.dispose();
				}
				else {
					JOptionPane.showMessageDialog(null, "課程已選修");
				}
			}
		}
	}
