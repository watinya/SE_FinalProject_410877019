...
public class setChangeStuInfoFrame implements ActionListener {
	Administrator user;
	JFrame f;
	//宣告輸入欄
    JTextField userId = new JTextField(9);

	public setChangeStuInfoFrame(Administrator user) {
		this.user = user;
		//設定框架
		f = new JFrame("修改學生資訊");
		f.setSize(450, 250);
